...
const ASSETS = [
  ...
  './js/features/quick-capture.js', './js/features/quick-capture-domain.js', './js/features/quick-capture-toolbar.js', './js/features/journey-ux.js', './js/features/capture-integrity.js',
