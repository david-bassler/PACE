...
const ASSETS = [
  ...
  './js/features/horizon.js', './js/features/navigation.js', './js/features/regulation-tools.js', './js/features/regulation-state.js', './js/features/regulation-state-data.js',
  './js/features/user-input-state.js', './js/features/user-input-state-data.js',
